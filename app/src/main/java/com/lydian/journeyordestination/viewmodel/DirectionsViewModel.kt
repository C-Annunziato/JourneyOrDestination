package com.lydian.journeyordestination.viewmodel


import androidx.lifecycle.*
import com.lydian.journeyordestination.model.Api.ApiResponseDirections.MapDataResponse
import com.lydian.journeyordestination.model.Api.RetrofitInstance
...
class DirectionsViewModel() : ViewModel() {
    ...
    private fun fetchDirectionsData() {
        val apiKey = com.lydian.journeyordestination.BuildConfig.DIRECTIONS_API_KEY
